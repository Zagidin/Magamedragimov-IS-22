...
frame1 = Frame(root, bg='#78a2b7')
frame1.pack()
frame2 = Frame(root)
frame2.pack()
frame3 = Frame(root, bg='#4faab3')
frame3.pack()
...
option_menu1 = OptionMenu(frame_form, country_var1, "Россия", "США", "Казахтан", "Индия", "Грузия")
...
label_frame1 = Label(frame1, text="Magamedragimov", font=('Arial bold', 20))
label_frame1.grid(row=5, column=5, padx=160, pady=180)

label_frame3 = Label(frame3, text="Zagidin", font=('Arial bold', 20))
label_frame3.grid(row=5, column=5, padx=240, pady=180)
